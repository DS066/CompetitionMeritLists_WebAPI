...
namespace CompetitionMeritLists_WebAPI.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class StudentsController : ControllerBase
    {
        private readonly CompetitionMeritLists_WebAPIContext _context;

        public StudentsController(CompetitionMeritLists_WebAPIContext context)
        {
            _context = context;
        }
